...
## 3. Conclusion
Random Forest algorithm is recommended because it is more accurate than Decision Tree. Accuracy for Random Forest model is equal/close to 100% (95% CI: (0.99, 1)) while Decision Tree has ~75% accuracy (95% CI: (0.75, 0.77)). The out-of-sample error for Random Forest is estimated to be slightly higher than in-sample error which is close to 0%. 
